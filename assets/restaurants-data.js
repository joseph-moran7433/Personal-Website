...
const restaurants = [
  ...
  },
  {
    ...
    source: "vetted",
    diningStyle: "fine-dining",
    vetting: { rating: 4.6, reviewCount: 3038, asOf: "2026-09-10", platform: "Google" },
    recognition: "MICHELIN Guide — 2 Stars",
    address: "1723 N Halsted St",
    priceLevel: 5,
    mealTypes: ["dinner"],
    hours: "Daily, opens 5 PM",
    knownFor: "Chef Grant Achatz's avant-garde, theatrical tasting menu — one of the most influential fine-dining restaurants in the country, two Michelin stars.",
